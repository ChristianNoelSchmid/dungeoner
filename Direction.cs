...
public static class DirectionExtensions { 
    ...
    public static Vector2I Vector(this Direction dir) => dir switch {
        Direction.Up => new (0, -1), Direction.UpRight => new(1, -1),
        Direction.Right => new(1, 0), Direction.DownRight => new(1, 1),
        Direction.Down => new(0, 1), Direction.DownLeft => new(-1, 1),
        Direction.Left => new(-1, 0), Direction.UpLeft => new(-1, -1),
