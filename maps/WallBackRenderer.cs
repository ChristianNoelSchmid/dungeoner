...
public partial class WallBackRenderer : WallPanelRenderer
{
    ...
    public override void UpdateWallMeta(WallInstance instance, Vector2I gridPosition)
    {
        _backPanel.Texture = instance.GetTexture(gridPosition);
        _leftDrywall.Modulate = _rightDrywall.Modulate = _topDrywall.Modulate = instance.Part.DrywallColor;
    }
