...
public partial class TileMap : Node2D, IEnumerable<KeyValuePair<Vector2I, Tile>> {
    ...
    public bool TryGetTile(Vector2I position, out Tile? tile) => _tiles.TryGetValue(position, out tile);
    ...
    IEnumerator<KeyValuePair<Vector2I, Tile>> IEnumerable<KeyValuePair<Vector2I, Tile>>.GetEnumerator()
