...
public partial class WallMap : Node2D {
    ...
    private PackedScene _backWallPane = ResourceLoader.Load<PackedScene>("res://Dungeoner.Game/maps/back_wall_template.tscn");
    // The Scene representing a side-panel wall
	private PackedScene _sideWallPane = ResourceLoader.Load<PackedScene>("res://Dungeoner.Game/maps/side_wall_template.tscn");
